...
//     $(".navigation").toggle();
//     $(".store-links, #postings, #map, #footer, #brand, .img-responsive").css({"opacity": "0.2"});
//     $(".navbar-text, .navbar-default, .navigation>li>a").css({"color": "black"});
//     $(".carousel-indicators, #input-box, #brand, img#search-2.search, #jumbo-banner, #footer, #social-and-banner-text").css({"opacity": "0.2"});
// });
